...
public class DbManager
{
	...
	public static void setDbConnection() throws SQLException, ClassNotFoundException, AddressException, MessagingException
	{
		...
		monitoringMail.sendMail(TestConfig.server, TestConfig.from, TestConfig.to, TestConfig.subject+" - (Script failed with Error, SQL database connection not established)", TestConfig.messageBody, TestConfig.attachmentPath, TestConfig.attachmentName);			
		}
    ...
    catch (Exception e)
    {
        ...
        monitoringMail.sendMail(TestConfig.server, TestConfig.from, TestConfig.to, TestConfig.subject+" - (Script failed with Error, MySQL database connection not established)", TestConfig.messageBody, TestConfig.attachmentPath, TestConfig.attachmentName);
    }
